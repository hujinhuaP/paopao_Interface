                    ...
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table,
                            ...
                            buttons: [
                                ...
                                {name: 'wait', icon: 'fa fa-pencil', classname: 'btn btn-xs btn-default btn-detail btn-dialog disabled', title:__('等待平台审核'), text:__('等待平台审核')},
                            ],
                            formatter: function (value, row, index) {
                                this.table.data('operate-edit', false);
                                this.table.data('operate-dragsort', false);
                                row[Table.config.dragsortfield] = 0;
                                if( row.group_certification_status == 'Y'){
                                    ...
                                    if(row.user_certification_status == 'C' || row.user_certification_video_status == 'C' || row.user_certification_image_status == 'C'){
                                        this.table.data('operate-wait', true);
                                    }
                                }else{
                                    this.table.data('operate-wait', false);
                                    if(row.user_certification_status == 'C' || row.user_certification_video_status == 'C' || row.user_certification_image_status == 'C'){
