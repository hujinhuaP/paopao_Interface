define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'video/category/index',
                    detail_url: '',
                    add_url: 'video/category/add',
                    del_url: 'video/category/delete',
                    edit_url: 'video/category/edit',
                    multi_url: '',
                    dragsort_url: 'video/category/sort',
                    status_url: 'video/category/status',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'logo', title: __('Image'), operate: false, formatter: function (value, row, index, custom) {
        ...
        edit: function () {
            ...
            // 给上传按钮添加上传成功事件
            $("#plupload-logo").data("upload-success", function (data) {
                var url = Backend.api.cdnurl(data.url);
                $(".logo-img").prop("src", url);
