            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'target_user.user_id', title: __('Target user id'), operate: false },
                        {field: 'target_user.user_nickname', title: __('Target nickname'), operate: false},
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'target_user.user_id', title: __('Source user id'), operate: false },
                        {field: 'target_user.user_nickname', title: __('Source nickname'), operate: false},
                        {field: 'remark', title: __('Remark'),  operate: false},
                    ]
                ],
