    ...
    var Pagination = {
        page : function (options) {
            ...
            if (totalPage > 0) {
                ...
                if (totalPage > showPage) $('#page').find('ul.pagination li.next').prev().removeClass('hidden');

                var pageObj = $('#page').find('ul.pagination'), preObj = pageObj.find('li.previous'),
                ...
                currentObj.click(function (event) {
                    ...
                    var currPage = Number($('#page').find('a').html()), activeObj = pageObj.find('li[class="active"]'),
                    ...
                    if (totalPage > showPage && currPage > 1)  {
                        ...
                        if (($('#page').prev().attr('class'))
                            && ($('#page').prev().attr('class').indexOf('disabled')) >= 0) {
                            minPage = currPage - 1;
                            maxPage = minPage + showPage - 1;
                            loopPageElement(minPage, maxPage);
                        } else if (($('#page').next().attr('class'))
                            && ($('#page').next().attr('class').indexOf('disabled')) >= 0) {
