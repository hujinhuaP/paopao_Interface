...
<body class="rel">
  <div class="wrap">
    <header class="none">
      <div class="title">
        <a href="javascript:;" class="fl"><img src="img/back1.png" alt=""></a>
        充值
      </div>
      <div class="person">
    ...
    <header class="noAccount ">
      <div class="title">
        <a href="javascript:;" class="fl"><img src="img/back.png" alt=""></a>
        充值
      </div>
      <div class="editInfo">
  ...
  <script>
    $(function() {
      ...
      $(".confirm2").on("click",function(){
          ...
          if(accountid!=''){
              //提交请求验证用户是否存在
              $.getJSON("index.php?uid="+accountid+"",function(result){
      ...
      $(".confirm1").on("click",function(){
            ...
            window.location.href = 'example/jsapi.php?id='+selected_payid;
            return false;
      });
