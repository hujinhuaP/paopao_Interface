...
class Backend extends Controller
{
     ...
     * 引入后台控制器的traits
     */
    use \app\live\library\traits\Backend;
     ...
     * @return array
     */
    protected function buildparams($searchfields = null, $relationSearch = null,$filter = '')
    {
    ...
    public function getDefaultTimeInterval($type = 'week')
    {
        ...
        return ['default_start_datetime' => $start,'default_end_datetime' => $end];
    }
