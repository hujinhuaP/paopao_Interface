...
class Rechargecombo extends Backend
{
    ...
    public function add()
    {
        ...
        if ( $this->request->isPost() ) {
            ...
            $row->user_recharge_is_first         = $params['user_recharge_is_first'];
            $row->user_recharge_combo_has_notify = $params['user_recharge_combo_has_notify'];
            $row->user_recharge_vip_reward_coin  = intval($params['user_recharge_vip_reward_coin']);
