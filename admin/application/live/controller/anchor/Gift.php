...
class Gift extends Backend
{
    ...
    public function add()
    {
        ...
        if ( $this->request->isPost() ) {
            ...
            $row->live_gift_type        = $params['live_gift_type'];
            $row->live_gift_source      = $params['live_gift_source'];
            $row->live_gift_notice_flg  = $params['live_gift_notice_flg'];
            ...
            $row->validate(
                ...
                [
                    ...
                    'live_gift_notice_flg.require'  => __('Parameter %s can not be empty', [ '送礼飘屏' ]),
                ]
            );
    ...
    public function sort()
    {
        if ( $this->request->isPost() ) {
            ...
            foreach ( $ids as $k => $id ) {
                LiveGift::where('live_gift_id', $id)->update([
                    'live_gift_sort'        => $k + 1,
                    'live_gift_update_time' => time()
                ]);
            }
            $this->success();
        }
