define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'id', title: 'ID'},
                        {field: 'nickname', title: __('代理商名称'),operate:false },
        ...
        edit: function () {
            ...
            $('input[type=radio][name="row[video_guide_flg]"]').change(function() {
                if($(this).val() == 'S'){
                    $('.guide-select').show();
                }else{
                    $('.guide-select').hide();
            ...
            $(".guideTimestampSelect").change(function(){
                let thisValue = $(this).val();
                if(thisValue){
                    let tv = thisValue.split('-');
                    $("#c-video_guide_hour_start").val(tv[0]);
                    $("#c-video_guide_hour_end").val(tv[1]);
                }
            });
        },
        add: function () {
