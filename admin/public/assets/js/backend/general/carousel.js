            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'carousel_title', title: '标题'},
                        {field: 'carousel_app_id', title: __('所属APP'), searchList:carouselApp, formatter:function (value, row, index) {
                                return carouselApp[value];
                            }},
                        ...
                        {field: 'carousel_target_type', title: __('跳转类型'), searchList:{
                                'externally': __('外链'),
                                'inviteFriend': __('邀请好友'),
                                'recharge': __('充值'),
                                'todaySignIn': __('签到'),
                                'download': __('直接下载'),
                        ...
                        {field: 'carousel_and_show', title: __('安卓显示'), searchList:{
                                'Y': __('Yes'),
                                'N': __('No'),
                            }, formatter:function (value, row, index) {
                                return value == 'Y' ? __('Yes') : __('No');
                            }},
                        {field: 'carousel_ios_show', title: __('iOS显示'), searchList:{
                                'Y': __('Yes'),
                                'N': __('No'),
                            }, formatter:function (value, row, index) {
                                return value == 'Y' ? __('Yes') : __('No');
