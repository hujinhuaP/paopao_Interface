define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/duration/index',
                    detail_url: 'activity/duration/detail'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'rank_flg', title: __('排行'), operate: false},
        ...
        detail: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/duration/detail/ids/'+ user_id
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        {field: 'state', checkbox: true},
                        {field: 'date_flg', title: __('日期'), operate: false},
                        {
                            field: 'duration',
                            title: __('时长'),
                            operate: false,
                        ...
                        {field: 'income', title: __('收益'), operate: false},
                    ]
                ],
