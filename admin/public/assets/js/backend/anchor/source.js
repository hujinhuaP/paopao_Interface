define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'anchor/source/index',
                    detail_url: 'anchor/source/detail',
                    add_url: '',
                    del_url: '',
                    edit_url: 'anchor/source/edit',
                    multi_url: '',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'status', title: __('审核状态'), searchList: {
                            'C': __('Checking'),
                            'Y': __('Pass'),
                            'N': __('Refuse'),
                        ...
                        {field: 'auth_type', title: __('审核类型'), searchList: {
                                'video': __('视频'),
                                'img': __('图片'),
                            }, formatter:function (value, row, index) {
                                switch (value) {
