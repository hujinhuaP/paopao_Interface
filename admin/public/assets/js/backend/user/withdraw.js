            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'service_charge', title: __('手续费'), operate: 'BETWEEN'},
                        {field: 'user_dot', title: __('佣金/现金'), operate: 'BETWEEN'},
                        {field: 'dot_type', title: __('类型'), searchList:{
                                'dot': __('佣金'),
                                'cash': __('现金'),
                            }, formatter:function (value, row, index) {
                                return value == 'dot' ? __('佣金') : __('现金');
                            }},
