define(['jquery','bootstrap','backend','table','form'],function ($,undefined,Backend,Table,Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'user_recharge_combo_coin',title: __('被邀请用户充值金币数'), operate:false},
        ...
        cash: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/invitereward/cash'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'user.user_id',title: __('被邀请用户ID')},
                        {field: 'user.user_nickname', title: __('被邀请用户昵称'), operate: 'LIKE %...%', placeholder: __('Like search'), style: 'width:200px'},
                        {field: 'user_recharge_combo_fee',title: __('被邀请用户操作金额（元）'), operate:false},
                        {field: 'user_invite_reward_type', title: __('Consume category'), searchList:{
                                'register':__('邀请注册收益'),
                                'recharge':__('邀请充值收益'),
                                'withdraw':__('邀请提现收益'),
                                'vip':__('邀请VIP收益'),
                        ...
                        {field: 'invite_ratio',title: __('奖励比例')},
                        {field: 'recharge_invite_cash',title: __('邀请用户所获得奖励“现金”'), operate:false},
                        {field: 'user_invite_reward_log_create_time', title: __('Operate time'), operate: 'BETWEEN', type: 'datetime', addclass: 'datetimepicker', data: 'data-date-format="YYYY-MM-DD HH:mm:ss"', formatter:function (value, row, index) {
                                return Table.api.formatter.datetime.call(this, value, row, index);
                            }}
                    ]
