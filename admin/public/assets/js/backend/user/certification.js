        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    add_url: '',
                    del_url: '',
                    edit_url: 'user/certification/edit',
                    multi_url: '',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'user.user_group_id', title: __('Group name'), searchList: groups, formatter:function (value, row, index) {
                                return groups[value];
                            }},
                        ...
                        {field: 'user_certification_create_time', title: __('Create time'), operate: 'BETWEEN', type: 'datetime', addclass: 'datetimepicker', data: 'data-date-format="YYYY-MM-DD HH:mm:ss"', formatter:function (value, row, index) {
                                return Table.api.formatter.datetime.call(this, value, row, index);
                            }},
                        {field: 'user_certification_update_time', title: __('Operate time'), operate: 'BETWEEN', type: 'datetime', addclass: 'datetimepicker', data: 'data-date-format="YYYY-MM-DD HH:mm:ss"', formatter:function (value, row, index) {
                                return Table.api.formatter.datetime.call(this, value, row, index);
                            }},
