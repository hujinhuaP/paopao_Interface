define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'subordinate/stat/index',
                    detail_url: '',
                    add_url: '',
                    edit_url: '',
                    multi_url: '',
                ...
                columns: [
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table,
                            ...
                            buttons: [
                                {name: 'childdata', icon: 'fa fa-yen', classname: 'btn btn-xs btn-primary btn-detail btn-dialog', url:'subordinate/stat/child', title:__('Child stat data'), text:__('Child stat data')},
                                {name: 'income', icon: 'fa fa-yen', classname: 'btn btn-xs btn-primary btn-detail btn-dialog', url:'subordinate/stat/income', title:__('Income log'), text:__('Income log')},
                            ],
        ...
        child: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'subordinate/stat/child/ids/' + parent_id,
                    detail_url: '',
                    add_url: '',
                    edit_url: '',
                    multi_url: '',
        ...
        income: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'subordinate/stat/income/ids/' + parent_id,
                    detail_url: '',
                    add_url: '',
                    edit_url: '',
                    multi_url: '',
