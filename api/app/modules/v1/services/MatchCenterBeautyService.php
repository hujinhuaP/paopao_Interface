...
/**
 * MatchCenterBeautyService 匹配大厅用户列表（高颜值区分）
 */
class MatchCenterBeautyService extends RedisService
{

    private $_key_all = 'match_center_beauty_list_all';

    private $_key_time = 'match_center_beauty_list_time';

    public function __construct()
    {
        parent::__construct();
        $this->_key = 'match_center_beauty_list';
